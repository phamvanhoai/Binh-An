  ...
  return (
    <div className="auth-shell min-h-screen overflow-x-hidden bg-[#06111f] text-slate-100">
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1500px] flex-col px-4 py-5 sm:px-6 lg:px-8">
        ...
        <section className="grid flex-1 items-center gap-6 py-5 lg:grid-cols-[1.08fr_0.92fr] lg:gap-6 xl:px-16">
          <article className="relative hidden min-h-[36rem] overflow-hidden rounded-2xl border border-white/10 bg-[#0d1727]/70 shadow-[0_32px_100px_rgba(0,0,0,0.32)] lg:block xl:min-h-[40rem]">
            <Image
              src="/assets/rituals/today-message-bg.png"
              width={1792}
              height={1024}
            ...
            <div className="relative z-10 mx-auto mt-24 max-w-lg text-center xl:mt-32">
              <p className="text-4xl leading-none text-amber-300">“</p>
              <h2 className="mt-3 text-3xl font-medium leading-[1.55] text-amber-100 xl:text-4xl">
          ...
          <div className="mx-auto w-full max-w-[34rem] xl:max-w-[37rem]">
            <LoginGlassForm />
          </div>
        </section>
      </main>
